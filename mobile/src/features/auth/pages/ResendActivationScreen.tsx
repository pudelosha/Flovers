  ...
  async function onSubmit() {
    ...
    try {
      ...
      setToast({
        visible: true,
        msg: getTranslation(
          "resendActivation.success.emailSent",
      ...
      const msg =
        e instanceof ApiError
          ...
          : getTranslation("resendActivation.errors.generic", "Something went wrong. Please try again.");
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <View style={s.container}>
        <TranslatedText tKey="resendActivation.title" variant="headlineMedium" style={s.title} />

        <TranslatedText tKey="resendActivation.subtitle" style={s.subtitle} />
        ...
        <LinkText
          ...
          text={getTranslation("resendActivation.backToLogin", "Back to Login")}
          style={s.linkTight}
        />
