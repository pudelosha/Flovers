      ...
      <View style={styles.backdrop}>
        <View style={styles.card}>
          <View style={styles.headerRow}>
            <MaterialCommunityIcons name="image-edit-outline" size={20} color="#FFFFFF" style={{ marginRight: 8 }} />
            <Text style={styles.title}>{tr("plantDetailsModals.changeImage.title", "Change image")}</Text>
          </View>
