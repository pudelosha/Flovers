              ...
              {statusOpen && (
                <View style={s.dropdownList}>
                  {[
                    {
                      key: undefined,
                      label: t("readingsModals.filter.anyStatus"),
                    },
                    {
                      key: "enabled",
                      label: t("readingsModals.filter.statusEnabled"),
                    },
                    {
                      key: "disabled",
                      label: t("readingsModals.filter.statusDisabled"),
                    },
                  ].map((opt) => (
                    <Pressable
