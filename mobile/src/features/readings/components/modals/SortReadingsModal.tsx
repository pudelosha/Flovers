        ...
        >
          ...
          >
              ...
              {keyOpen && (
                <View style={[s.dropdownList, styles.ddListFlat]}>
                  {[
                    ...
                    {
                      key: "location",
                      label: t("readingsModals.sort.keyLocation"),
                    },
                    {
                      key: "lastRead",
                      label: t("readingsModals.sort.keyLastRead"),
                    },
                  ].map((opt) => (
                    <Pressable
                      key={opt.key}
            ...
            <Text style={s.inputLabel}>
              {t("readingsModals.sort.direction")}
            </Text>
            ...
            <View style={s.dropdown}>
              ...
              >
                <Text style={s.dropdownValue}>
                  {d === "asc"
                    ? t("readingsModals.sort.ascending")
                    : t("readingsModals.sort.descending")}
                </Text>
