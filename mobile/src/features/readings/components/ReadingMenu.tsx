...
export default function ReadingMenu({
  ...
  return (
    <View style={s.menuSheet} pointerEvents="auto">
      <Item
        icon="pencil-outline"
        label={tr("readings.menu.editDevice", "Edit device")}
        onPress={onEdit}
      />

      <Item
        icon="information-outline"
        label={tr("readings.menu.deviceDetails", "Device details")}
        onPress={onDeviceDetails}
      />

      <Item
        icon="chart-line"
        label={tr("readings.menu.history", "Readings history")}
        onPress={onHistory}
      />

      <Item
        icon="sprout-outline"
        label={tr("readings.menu.plantDetails", "Plant details")}
        onPress={onPlantDetails}
      />

      <Item
        icon="trash-can-outline"
        label={tr("readings.menu.deleteDevice", "Delete device")}
        danger
        onPress={onDelete}
      />
    </View>
