...
import { header as h, layout as ly, prompts as pr } from "./profile.styles";
import { HEADER_GRADIENT_TINT, HEADER_SOLID_FALLBACK } from "./profile.constants";
import type { TabKey, PromptKey, LangCode } from "./profile.types";
